...
const MaintenanceStaffDetail = () => {
  ...
  const handleDownloadPDF = () => {
    html2pdf(pdfRef.current, {
      margin: 0.5,
      filename: `${maintenanceStaff?.userId?.fullName}_maintenanceStaff.pdf`,
      ...
      <div className="card shadow-sm p-3" ref={pdfRef}>
        <div className="row">
          <div className="col-md-6 mb-2">
            ...
            <span>{" "}{maintenanceStaff?.userId?.fullName}</span>
          </div>
          <div className="col-md-6 mb-2">
            <label className="fw-bold">Mobile:</label>
            <span>{" "}{maintenanceStaff?.userId?.mobile}</span>
          </div>
          <div className="col-md-6 mb-2">
            <label className="fw-bold">Email:</label>
            <span>{" "}{maintenanceStaff?.userId?.email}</span>
          </div>
          <div className="col-md-6">
            <label className="fw-bold">Status:</label>
            <span>{" "}{maintenanceStaff?.userId?.status}</span>
          </div>
          <div className="col-md-6">
            <label className="fw-bold">ID:</label>
            <span>{" "}{maintenanceStaff?.userId?.memberId}</span>
          </div>
          <div className="col-md-6">
            <label className="fw-bold d-block mb-1">Profile Photo:</label>
            <img src={maintenanceStaff?.userId?.profilePhoto} alt="profileImage" className="img-thumbnail" style={{ maxHeight: "200px" }} />
          </div>
          <div className="col-md-6">
