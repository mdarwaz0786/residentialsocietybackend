...
router.post("/create-vehicle", isLoggedIn, checkPermission("vehicle", "create"), upload.single("vehiclePhoto"), validateFileSize, createVehicle);
...
router.put("/update-vehicle/:id", isLoggedIn, checkPermission("vehicle", "update"), upload.single("vehiclePhoto"), validateFileSize, updateVehicle);
