...
router.post("/create-flatOwner", isLoggedIn, checkPermission("flatOwner", "create"), upload.fields([{ name: "profilePhoto", maxCount: 1 }, { name: "aadharCard", maxCount: 1 }, { name: "allotment", maxCount: 1 }]), validateFileSize, createFlatOwner);
...
router.put("/update-flatOwner/:id", isLoggedIn, checkPermission("flatOwner", "update"), upload.fields([{ name: "profilePhoto", maxCount: 1 }, { name: "aadharCard", maxCount: 1 }, { name: "allotment", maxCount: 1 }]), validateFileSize, updateFlatOwner);
