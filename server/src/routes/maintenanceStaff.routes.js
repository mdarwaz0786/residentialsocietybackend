...
router.patch("/update-maintenanceStaff/:id", isLoggedIn, checkPermission("maintenanceStaff", "update"), upload.fields([{ name: "profilePhoto", maxCount: 1 }, { name: "aadharCard", maxCount: 1 }]), validateFileSize, updateMaintenanceStaff);
